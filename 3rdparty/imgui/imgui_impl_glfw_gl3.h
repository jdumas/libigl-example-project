...
IMGUI_API void        ImGui_ImplGlfwGL3_MouseButtonPressedCallback(int button, int mods);
IMGUI_API void        ImGui_ImplGlfwGL3_ScrollCallback(double yoffset);
IMGUI_API void        ImGui_ImplGlfwGL3_KeyCallback(int key, int action, int mods);
